        ...
        <div class="content">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <router-link to="/teacher/addnotes" class="btn btn-success min-width-125"> Add Payments</router-link>
                ...
                <div class="block-content block-content-full">
                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <b-table responsive striped hover show-empty :items="payments" :fields="fields" :per-page="perPage" :current-page="currentPage" :filter="filter" :filterIncludedFields="filterOn" @filtered="onFiltered">
                    ...
                    <form @submit.prevent="updateUnit">
                        <div class="block block-themed block-transparent mb-0">
                            <div class="block-header bg-primary-dark">
                                <h3 class="block-title">Update Payment</h3>
                            ...
                            <div class="block-content">
                                <div class="form-group">
                                    <label class="col-12" for="example-text-input">Payments</label>
                                </div>
                            </div>
                        </div>
...
export default {
    data() {
        return {
            ...
            perPage: 5,
            items: [],
            fields: ['#', { key: 'Full Name',  }, { key: 'phoneNumber', }, { key: 'email', },'unit','amount','date', { key: 'actions', label: 'Actions' }],
            payments: [{}],
            filter: null,
            filterOn: [],
            form: new Form({
