...
<template>
    <section>
        <div class="content">
            <h2 class="content-heading">Expenses</h2>
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title"><small></small></h3>
                    <router-link to="/teacher/addnotes" class="btn btn-success min-width-125"> Add Expense</router-link>
                ...
                <div class="block-content block-content-full">
                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <b-table responsive striped hover show-empty :items="expenses" :fields="fields" :per-page="perPage" :current-page="currentPage" :filter="filter" :filterIncludedFields="filterOn" @filtered="onFiltered">
                    ...
                    <form @submit.prevent="updateUnit">
                        <div class="block block-themed block-transparent mb-0">
                            <div class="block-header bg-primary-dark">
                                <h3 class="block-title">Update Expense</h3>
