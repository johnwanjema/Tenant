...
<template>
    <section>
        <div class="content">
            <h2 class="content-heading">Units</h2>
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title"><small></small></h3>
                    <router-link to="/teacher/addnotes" class="btn btn-success min-width-125"> Add Unit</router-link>
                ...
                <div class="block-content block-content-full">
                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <b-table responsive striped hover show-empty :items="units" :fields="fields" :per-page="perPage" :current-page="currentPage" :filter="filter" :filterIncludedFields="filterOn" @filtered="onFiltered">
                                    ...
                                    <template v-slot:cell(actions)="row">
                                        ...
                                        <b-button class="btn btn-sm" variant="warning" @click="openModal(row.item)">
                                            Edit
                                        </b-button>
                                    </template>
                                </b-table>
                    ...
                    <form @submit.prevent="updateUnit">
                        <div class="block block-themed block-transparent mb-0">
                            <div class="block-header bg-primary-dark">
                                <h3 class="block-title">Update Unit</h3>
                            ...
                            <div class="block-content">
                                <div class="form-group">
                                    <label class="col-12" for="example-text-input">Unit</label>
                                </div>
                            </div>
                        </div>
...
export default {
    data() {
        return {
            ...
            perPage: 5,
            items: [],
            fields: ['#', { key: 'unitName', label: 'Unit Name' }, { key: 'Adress', }, 'status', { key: 'actions', label: 'Actions' }],
            units: [{}],
            filter: null,
            filterOn: [],
            form: new Form({
