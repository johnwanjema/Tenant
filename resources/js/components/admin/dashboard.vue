...
<div class="content">
                    ...
                    <div class="row row-deck gutters-tiny js-appear-enabled animated fadeIn" data-toggle="appear">
                        <!-- Row #2 -->
                        <div class="col-xl-4">
                        ...
                        <div class="col-xl-8 d-flex align-items-stretch">
                            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url('assets/media/photos/photo34@2x.jpg');">
                                ...
                                <div class="block-content bg-black-op">
                                    <div class="pull-r-l"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        ...
                                        <canvas class="js-chartjs-dashboard-lines chartjs-render-monitor" style="display: block; width: 757px; height: 378px;" width="757" height="378"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
